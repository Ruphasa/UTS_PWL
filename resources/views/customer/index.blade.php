							...
							<ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
								...
								<li class="nav-item dropdown">
									<a class="nav-link" data-toggle="dropdown" href="#">
										<img src="/../UTS_PWL/public/Adminlte/dist/img/{{ Auth::user()->username }}.png"
									...
									<div class="dropdown-menu dropdown-menu-right">
										<div class="dropdown-header">
											<div class="media align-items-center">
												<img src="/../UTS_PWL/public/Adminlte/dist/img/{{ Auth::user()->username }}.png"
													alt="" class="img-size-40 img-circle mr-3">
										...
										<div class="p-3 text-center">
											<button class="btn btn-primary btn-sm btn-block">Change Image</button>
										</div>
									</div>
								</li>
							</ul><!--/.nav -->
	...
	<section id="new-goods" class="new-goods">
		<div class="container">
			...
			<div class="new-goods-content">
				<div class="owl-carousel owl-theme" id="new-goods-carousel">
					@foreach ($barang->take(3) as $b)
		...
		<div class="container">
			<div class="brand-area">
				<div class="owl-carousel owl-theme brand-item">
					@foreach ($barang->take(6) as $b)
						<div class="item">
							<a href="#">
								<img src="{{asset('awo/assets/images/brand/br1.png')}}" alt="brand-image" />
							</a>
						</div><!--/.item-->
					@endforeach
				</div><!--/.owl-carousel-->
